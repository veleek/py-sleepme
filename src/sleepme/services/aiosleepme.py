...
async def get_device_state(device_id: str, api_config_override: Optional[APIConfig] = None) -> DeviceState:
    async with get_client(api_config_override) as client:
...
async def update_device(device_id: str, body: DeviceControl, api_config_override: Optional[APIConfig] = None) -> UpdateResponse:
