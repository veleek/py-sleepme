...
.. |commits-since| image:: https://img.shields.io/github/commits-since/veleek/py-sleepme/v0.0.9.svg
    :alt: Commits since latest release
    :target: https://github.com/veleek/py-sleepme/compare/v0.0.9...main
